...
export default function LinkConformModal({
  isOpen,
  onClose,
  onOk,
  closeOnEscape,
    ...
    >
      {isOpen && (
        <div className={styles.emailConfirmWrap}>
          ...
          <p className={styles.modulpara}>
            Selected Ticket will not be linked once again after linking done.
          </p>
          <Button className={styles.cancel} onClick={onClose}>
            Cancel
          </Button>
          <Button className={styles.conform} onClick={onOk}>
            Conform
          </Button>
        </div>
      )}
